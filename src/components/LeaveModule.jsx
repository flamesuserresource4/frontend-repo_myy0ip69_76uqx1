...
import { Calendar, ClipboardList, UserCheck, FileCheck2, Plane, ChevronRight, CheckCircle2 } from 'lucide-react';
...
const flows = [
  {
    ...
    steps: [
      'Create leave types (Annual, Sick, Unpaid)',
      'Define accrual rules and carryover caps',
      'Configure holidays and blackout dates',
      'Assign policies by role or location'
    ],
  },
  {
    ...
    steps: [
      'Employees submit requests with notes',
      'Auto detect conflicts and balances',
      'Manager approve/decline with comments',
      'Notify via email and in-app'
    ],
  },
  {
    key: 'travel',
    title: 'Travel & Out-of-Office',
    icon: Plane,
    gradient: 'from-amber-400 via-orange-500 to-red-600',
    steps: [
      'Add travel itineraries and visa docs',
      'Set coverage and handover tasks',
      'Auto-update calendars and status',
...
export default function LeaveModule({ onBack }) {
  return (
    <div className="relative min-h-screen bg-slate-950 px-6 py-8">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-24 left-0 h-96 w-96 rounded-full bg-emerald-500/10 blur-3xl" />
      ...
      <header className="relative z-10 flex items-center justify-between">
        <div>
          <h2 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-white via-emerald-200 to-cyan-200 bg-clip-text text-transparent">Leave Module</h2>
          <p className="text-slate-300">Everything for time-off, travel, and payroll alignment</p>
        </div>
        ...
        {flows.map((f, idx) => (
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <button className="mt-4 inline-flex items-center gap-1 text-emerald-300 hover:text-white transition">
